...
module.exports = function() {
  ...
  // Returns userobj
  setUserActivityEval = async function (username, activityID, activityEval) {
    const client = new MongoClient(
      'mongodb+srv://SENG:513@cluster0.a7uvh.mongodb.net/test');
    try {
      await client.connect();
  ...
  addToFriendsList = async function (username, friendUsername) {
    const client = new MongoClient(
      'mongodb+srv://SENG:513@cluster0.a7uvh.mongodb.net/test');
    try {
      await client.connect();
  ...
  getChat = async function (username, friendUsername) {
    const client = new MongoClient(
      'mongodb+srv://SENG:513@cluster0.a7uvh.mongodb.net/test');
    try {
      await client.connect();
  ...
  acceptFriendRequest = async function (username, userToAccept) {
    const client = new MongoClient(
      'mongodb+srv://SENG:513@cluster0.a7uvh.mongodb.net/test');
    try {
      await client.connect();
  ...
  sendChat = async function (sentBy, sentTo, message) {
    const client = new MongoClient(
      'mongodb+srv://SENG:513@cluster0.a7uvh.mongodb.net/test');
    try {
      await client.connect();
